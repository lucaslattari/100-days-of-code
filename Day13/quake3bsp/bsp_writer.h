...
private:
    ...
    void    printEachFaceDataInLog(Face* faceObject);
    void    printEachLightmapVolDataInLog(LightmapVolume* lightmapVolumeObject);
    void    printEachLightmapColorDataInLog(LightmapColor* lightmapColorObject);
    void    printEachVisDataDataInLog(VisibilityData* visDataObject);
