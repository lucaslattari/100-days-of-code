...
const int                   sizeOfTextureInBytes            = sizeof(char) * 64 + sizeof(int) * 2;
const int                   sizeOfPlaneInBytes              = sizeof(float) * 4;
const int                   sizeOfNodeInBytes               = sizeof(int) * 9;
const int                   sizeOfLeafInBytes               = sizeof(int) * 12;
const int                   sizeOfLeafFaceInBytes           = sizeof(int);
const int                   sizeOfLeafBrushInBytes          = sizeof(int);
const int                   sizeOfModelInBytes              = sizeof(float) * 6 + sizeof(int) * 4;
const int                   sizeOfBrushInBytes              = sizeof(int) * 3;
const int                   sizeOfBrushSideInBytes          = sizeof(int) * 2;
const int                   sizeOfFaceVertexInBytes         = sizeof(float) * 10 + sizeof(unsigned char) * 4;
const int                   sizeOfTriangleMeshVertexInBytes = sizeof(int);
const int                   sizeOfEffectInBytes             = sizeof(char) * 64 + sizeof(int) * 2;
const int                   sizeOfFaceInBytes               = sizeof(int) * 14 + sizeof(float) * 12;
const int                   sizeOfLightmapVolsInBytes       = sizeof(unsigned char) * 8;
const int                   sizeOfLightmapColorsInBytes     = sizeof(unsigned char) * 128 * 128 * 3;
