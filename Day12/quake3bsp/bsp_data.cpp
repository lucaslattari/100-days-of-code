...
LumpArray<Face>* BSPData::getFaceObject()
{
    return &faces;
}

LumpArray<LightmapVolume>* BSPData::getLightmapVolumeObject()
{
    return &lightmapVolumes;
}

LumpArray<LightmapColor>* BSPData::getLightmapColorObject()
{
    return &lightmapColors;
}

VisibilityData* BSPData::getVisDataObject()
{
